  ...
  return (
    <div>
      ...
      <div class="schedule-bottom">
        ...
        <div class="col-md-6 agileits_schedule_bottom_right">
          <div class="w3ls_schedule_bottom_right_grid">
            <h3>Economisez jusqu'à <span>50%</span> dans vos dépenses</h3>
            <p>A chacun sa chance !. 
             Toi aussi tu peux essayer d'économiser au max lors de tes achats. Sauf que là, c'est pas une question de chance. Tu économiseras c'est sûr.</p>
            <div class="col-md-4 w3l_schedule_bottom_right_grid1">
              <i class="fa fa-user-o" aria-hidden="true"></i>
              <h4>Clients</h4>
              <h5 class="counter">16853</h5>
            </div>
            <div class="col-md-4 w3l_schedule_bottom_right_grid1">
              <i class="fa fa-calendar-o" aria-hidden="true"></i>
              <h4>Utilisateur journalier</h4>
      ...
      <div class="banner-bootom-w3-agileits">
        <div class="container">
          <h3 class="wthree_text_info">Catégories <span>Tendances</span></h3>
      ...
      <div class="new_arrivals_agile_w3ls_info"> 
		<div class="container">
		    <h3 class="wthree_text_info">Produits <span>Populaires</span></h3>		
            ...
            <div class="w3layouts_mail_grid">
              <div class="col-md-3 w3layouts_mail_grid_left">
                ...
                <div class="w3layouts_mail_grid_left2">
                  ...
                  <p>Nos partenaires vous livreront vos articles en moins d'une heure</p>
                </div>
              </div>
              <div class="col-md-3 w3layouts_mail_grid_left">
                <div class="w3layouts_mail_grid_left1 hvr-radial-out">
                ...
                <div class="w3layouts_mail_grid_left2">
                  <h3>SUPPORT 24/7</h3>
                  <p>Notre comparaison est disponible à chaque instant, une équipe prête à vous servir</p>
                </div>
              </div>
              <div class="col-md-3 w3layouts_mail_grid_left">
                <div class="w3layouts_mail_grid_left1 hvr-radial-out">
                ...
                <div class="w3layouts_mail_grid_left2">
                  <h3>QUALITE DE SERVICE HAUT DE GAMME</h3>
                  <p>Nous vous promettons que vous ne serez pas deçus dans votre recherche du produit le moins cher</p>
                </div>
              </div>
                <div class="col-md-3 w3layouts_mail_grid_left">
                <div class="w3layouts_mail_grid_left1 hvr-radial-out">
                ...
                <div class="w3layouts_mail_grid_left2">
                  <h3>COUPONS DE REDUCTION GRATUITS</h3>
                  <p>De temps en temps, nos vendeurs partenaires mettent à votre disposition des coupons de reduction sur vos achâts</p>
                </div>
              </div>
              <div class="clearfix"> </div>
            </div>
